...
@AllArgsConstructor
@Getter
public class MemorySortingProcessor<K,V> implements SortingProcessor{

    public static <K,V> MemorySortingProcessorBuilder<K,V> builder(){
        return new MemorySortingProcessorBuilder<K,V>();
    }
